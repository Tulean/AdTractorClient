...
export class Home extends Component {
  ...
  handleOpenOutSide = () => {
    window.open('https://www.serpwizard.com/differences-between-web-3-0-and-web-2-0-websites/', '_blank')
  };
            ...
            <Grid container item direction="row" className={classes.text}>
              <Grid item xs={5} className={classes.text}>
                <Typography paragraph="true" variant="subtitle1">
                  ...
                  become the past tense soon. Why? Web 2.0 is a writable  
                  and more social oriented World Wide Web that uses Google 
                  as a catalyst to perform. It means we have a CENTRALIZED
                  server -- Google. Everyone's data is stored in here and 
                  sellable. Web3 is a dAPP -- Decentralized Application. 
                </Typography>
                <Typography variant="button">
                  <Button
                    variant="outlined"
          ...
          >
            ...
            <Grid container item direction="row" className={classes.text}>
              <Grid item xs={5} className={classes.text}>
                ...
                in your browser today. It allows you to run Ethereum dApps right in your browser 
          ...
          >
            ...
            <Grid container item direction="row" className={classes.text}>
              <Grid item xs={5} className={classes.text}>
                ...
                functionality. It supports a modified version of Nakamoto consensus 
                via transaction-based state transitions. Ether is a token whose 
                blockchain is generated by the Ethereum platform
                </Typography>
                <Typography variant="button">
                  <Button
                    variant="outlined"
